        ...
        <nav>
            ...
            <div className='s2'>
                ...
                <Dropdown>
                    ...
                    <Dropdown.Menu>
                        <Dropdown.Item href="#/action-1">Men's section</Dropdown.Item>
                        <Dropdown.Item href="#/action-2">Women's section</Dropdown.Item>
                        <Dropdown.Item href="#/action-3">Kid's section</Dropdown.Item>
                    </Dropdown.Menu>
                </Dropdown>
                <Link to='/about'>
                    <a>About Us</a>
