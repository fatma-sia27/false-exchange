    ...
    <div className='footer'>
      <div className='footerin1'>
        <div className='f1'>
          ...
          <p>Shopper's stoppage is a leading online store for clothing in the USA. We are committed to providing the best quality clothing at the best prices.</p>
      ...
      <div className='footerin2'>
        <h3>© Copyright 2023 Shopper's stoppage, Inc.  All rights reserved</h3>
